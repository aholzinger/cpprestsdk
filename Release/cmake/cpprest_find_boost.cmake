...
function(cpprest_find_boost)
  ...
  elseif(UNIX)
    if(BOOST_VERSION_MIN)
      message(STATUS "Searching Boost version " ${BOOST_VERSION_MIN})
      find_package(Boost ${BOOST_VERSION_MIN} REQUIRED COMPONENTS random system thread filesystem chrono atomic date_time regex)
    else()
      find_package(Boost REQUIRED COMPONENTS random system thread filesystem chrono atomic date_time regex)
    endif()
  else()
    if(BOOST_VERSION_MIN)
      message(STATUS "Searching Boost version " ${OOST_VERSION_MIN})
      find_package(Boost ${BOOST_VERSION_MIN} REQUIRED COMPONENTS system date_time regex)
  else()
